...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="This is the Warnings Screen!"
                                    "Agree or Disagree!", font=LARGE_FONT)
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1.pack()
        button4 = ttk.Button(self, text="Visit Graph Page", command=lambda: controller.show_frame(BTCe_Page))
        button4.pack()
